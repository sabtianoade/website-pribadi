...
export default function SpotifyWidget() {
  return (
    <motion.div 
      ...
      className="fixed bottom-6 left-6 z-40 hidden md:flex items-center gap-4 bg-[var(--card)]/80 backdrop-blur-xl border border-[var(--card-border)] p-3 pr-6 rounded-2xl shadow-xl hover:border-[#1DB954]/50 transition-colors cursor-pointer group"
