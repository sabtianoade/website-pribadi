...
export default function SpotifyWidget() {
  return (
    <motion.div 
      ...
      className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-40 flex items-center gap-3 md:gap-4 bg-[var(--card)]/80 backdrop-blur-xl border border-[var(--card-border)] p-2 md:p-3 pr-4 md:pr-6 rounded-2xl shadow-xl hover:border-[#1DB954]/50 transition-colors cursor-pointer group scale-90 md:scale-100 origin-bottom-right"
